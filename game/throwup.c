...
void ThrowUpNow(edict_t *self)
{
	...
	rnum = random();
	if (rnum < 0.125)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "gurp1"), 1, ATTN_NORM, 0);
	else if (rnum < 0.25)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "gurp2"), 1, ATTN_NORM, 0);
	else if (rnum < 0.375)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain50_1"), 1, ATTN_NORM, 0);
	else if (rnum < 0.5)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain50_2"), 1, ATTN_NORM, 0);
	else if (rnum < 0.625)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain75_1"), 1, ATTN_NORM, 0);
	else if (rnum < 0.75)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain75_2"), 1, ATTN_NORM, 0);
	else if (rnum < 0.875)
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain100_1"), 1, ATTN_NORM, 0);
	else
		gi.sound(self, CHAN_BODY, gi.soundindex(self, "pain100_2"), 1, ATTN_NORM, 0);
